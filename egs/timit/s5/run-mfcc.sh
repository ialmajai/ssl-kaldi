...
#
# This is Kaldi's original MFCC recipe, kept as the baseline for run.sh
# (which replaces the MFCCs with SSL features). Only the GMM stages are kept.

# Path to the TIMIT corpus, i.e. the directory containing TRAIN/ and TEST/.
# Override on the command line: ./run-mfcc.sh --timit /path/to/TIMIT
